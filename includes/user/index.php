    ...
    <div class="container">
      <div class="item_container">
        <div class="box">
          ...
          <div class="img-box">
            <img src="../../assets/images/i-1.png" alt="bijoux d'or">
          </div>
          <div class="name">
            <h5>
              Bracelet
        ...
        <div class="box">
          ...
          <div class="img-box">
            <img src="../../assets/images/i-2.png" alt="bijoux d'or 2">
          </div>
          <div class="name">
            <h5>
              Ring
        ...
        <div class="box">
          ...
          <div class="img-box">
            <img src="../../assets/images/i-3.png" alt="bijoux d'or 3">
          </div>
          <div class="name">
            <h5>
              Earings
    ...
    <div class="container">
      ...
      <div class="price_container">
        <div class="box">
          ...
          <div class="img-box">
            <img src="../../assets/images/p-1.png" alt="prod 1">
          </div>
          <div class="detail-box">
            <h5>
              $<span>1000.00</span>
        ...
        <div class="box">
          ...
          <div class="img-box">
            <img src="../../assets/images/i-2.png" alt="prod 2">
          </div>
          <div class="detail-box">
            <h5>
              $<span>1000.00</span>
        ...
        <div class="box">
          ...
          <div class="img-box">
            <img src="../../assets/images/i-3.png" alt="prod 3">
          </div>
          <div class="detail-box">
            <h5>
              $<span>1000.00</span>
