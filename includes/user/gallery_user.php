        ...
        <div class="container" id="prod">
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="info">
                <p>BRACELET</p>
                <img src="assets/images/i-1.png" alt="bracelet">
            ...
            <div class="col-md-3">
              <div class="info">
                <p>EARINGS</p>
                <img src="assets/images/i-2.png" alt="EARINGS">
            ...
            <div class="col-md-3">
              <div class="info">
                <p>EARINGS</p>
                <img src="assets/images/i-3.png" alt="EARINGS">
         ...
         <!-- row 2 -->
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="info">
                <p>RING</p>
                <img src="assets/images/i-3.png" alt="RING">
                <p>$<span class="price">100.00</span></p>
                <p class="buy">buy now</p>
              </div>
            </div>
            <div class="col-md-3">
              <div class="info">
                <p>Diamond Ring</p>
                <img src="assets/images/i-1.png" alt="Diamond Ring">
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="info">
                <p>RING</p>
                <img src="assets/images/i-3.png" alt="Diamond Ring">
            ...
            <div class="col-md-3">
              <div class="info">
                <p>Diamond Ring</p>
                <img src="assets/images/i-1.png" alt="ring">
